...
$(shell mkdir -p $(TARGET_OUT_KEYLAYOUT); \
    cp -pf device/mediatek/mt6592/keylayout/Generic.kl $(TARGET_OUT_KEYLAYOUT))

# copy permissions overrides
$(shell mkdir -p $(TARGET_OUT_ETC)/permissions; \
    cp -pf device/mediatek/mt6592/configs/android.hardware.camera.xml $(TARGET_OUT_ETC)/permissions)
